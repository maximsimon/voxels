...
void MeshVoxel(Mesh& mesh, float pos_x, float pos_y, float pos_z, float angle, int *voxel_count, int texture_type);	// Generate a voxel at given position (pos_x, pos_y, pos_z), voxel_count is number of voxels already in mesh

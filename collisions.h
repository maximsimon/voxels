...
bool CheckCollision(Camera *camera, chunkMap map, const float speed, Vector3 direction);		// Check if player is colliding with any voxel
...
bool CheckCollision(Camera *camera, chunkMap map, const float speed, Vector3 direction) {
